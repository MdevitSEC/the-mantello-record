...
Council Member McLaren asked how $3.6 million addresses a project that could cost twice as much. Donnelly said the parks were the priority: the North Lake Avenue playground is inaccessible to wheelchairs, strollers, and transport chairs; the lower playground near Martin Luther King is heavily used and outdated; the tennis courts are in poor shape. The vision for the North Lake side was a fully inclusive playground, with wide ramps, accessible swings, and sensory equipment, something that does not exist regionally and could function as a destination. If Park Pub renovations come in under budget, more of the allocation could shift to the park itself. If the building cannot be saved, it could be demolished.
